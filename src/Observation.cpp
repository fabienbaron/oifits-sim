...
{
  return this->mbHasVIS;

}// A simple function to see if the observation has powerspectra.

bool    Observation::HasV2(void)
{
  return this->mbHasV2;
}

// A simple function to see if the observation has triplets.
bool    Observation::HasT3(void)
{
  return this->mbHasT3;
}

// A simple function to see if the observation has quadruplets.
bool    Observation::HasT4(void)
{
    return this->mbHasT4;
}
