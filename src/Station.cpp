...
/// ABC_is_XYZ permits specification of the XYZ coordinates if true.  If false
/// input the (A=North, B=East, C=Up) coords
...
Station::Station(double array_lat, string station_name, int sta_index, bool ABC_is_XYZ, double A, double B, double C, AtmosphereLayer *atm, double gain,
                 double diameter) {
  this->sta_name = station_name;
  this->sta_index = sta_index;
  this->layer = atm;
...
string Station::GetName(void) { return this->sta_name; }

int Station::GetIndex(void) { return this->sta_index; }
