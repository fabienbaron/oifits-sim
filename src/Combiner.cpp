...
Combiner::Combiner() { this->name = ""; }

Combiner::~Combiner() {}

void Combiner::ImportFile(string filename, string comment_chars) {
  // Some local variables
  int max_params = 15; // This is the number of non-telescope parameters found
                       // in the array definition file.
  int n_params = 0;    // the number of parameters read in from the file

  int line_number;

  // We permit shortcuts in the name of the combiners.  See if the absolute path
  // was given, otherwise
...
string Combiner::GetName(void) { return this->name; }

double Combiner::GetThroughput(void) { return this->int_trans; }

int Combiner::GetNumPhotometricPixels() { return this->n_pix_photometry; }
int Combiner::GetNumFringePixels() { return this->n_pix_fringe; }

double Combiner::GetPhotometryFluxFrac() { return this->flux_frac_photometry; }
double Combiner::GetFringeFluxFrac() { return this->flux_frac_fringes; }

double Combiner::GetPhotometryThroughput() { return this->throughput_photometry; }
double Combiner::GetFringeThroughput() { return this->throughput_fringes; }

double Combiner::GetNumSplits() { return this->n_splits; }
