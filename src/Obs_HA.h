...
class Obs_HA : public Observation
{
  ...
  public:
    ...
    void  WriteVis(fitsfile* outfile, UVPoint** puv_list, complex<double>** pcvis, Array * array, Combiner * combiner, SpectralMode * spec_mode, Target * target, NoiseModel * noisemodel, Rand_t random_seed);
    void WriteVis2(fitsfile* outfile, UVPoint** puv_list, complex<double>** pcvis, Array * array, Combiner * combiner, SpectralMode * spec_mode, Target * target, NoiseModel * noisemodel, Rand_t random_seed);
    void   WriteT3(fitsfile* outfile, UVPoint** puv_list, complex<double>** pcvis, Array * array, Combiner * combiner, SpectralMode * spec_mode, Target * target, NoiseModel * noisemodel, Rand_t random_seed);
    void   WriteT4(fitsfile* outfile, UVPoint** puv_list, complex<double>** pcvis, Array * array, Combiner * combiner, SpectralMode * spec_mode, Target * target, NoiseModel * noisemodel, Rand_t random_seed);
