...
Quadruplet::Quadruplet(Array *array, Station *station1, Station *station2, Station *station3, Station *station4) {
  ...
  baseline = station3->GetName() + '-' + station4->GetName(); // cd
  ...
  // mBaselines[2]->GetName().c_str(),  mBaselines[3]->GetName().c_str());
}

/// Returns the name of this quadruplet as the names of the stations separated
/// by hyphens, e.g.:
///     S1-E1-E2
string Quadruplet::GetName(void) { return this->name; }
